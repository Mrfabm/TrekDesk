    ...
    const baseColumns = [
      {
        ...
        headerClassName: 'text-xs font-medium text-gray-500 uppercase tracking-wider px-4 py-3 text-left',
      ...
      },
      {
        ...
        accessor: 'product',
        cell: (value) => {
          const formattedValue = value === 'Mountain gorillas' ? 'Mountain Gorillas' : 
                               value === 'Golden monkeys' ? 'Golden Monkeys' : value;
          return <span className="text-sm font-medium text-gray-900">{formattedValue}</span>;
        },
        headerClassName: 'text-xs font-medium text-gray-500 uppercase tracking-wider px-4 py-3 text-left',
        cellClassName: 'px-4 py-3 text-left'
      },
      ...
      },
      {
        ...
        accessor: 'status',
        cell: (value, row) => (
          <span className={`inline-flex px-2 py-1 rounded-full text-sm font-medium ${getStatusBadgeColor(value, row.validation_status)}`}>
