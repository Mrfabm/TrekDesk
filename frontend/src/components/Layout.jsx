...
const Layout = ({ children }) => {
  ...
  const navLinkClass = "group py-3 px-4 flex items-center space-x-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-md";
  ...
  const renderNavItems = () => {
      ...
      return (
        <>
          ...
          <Link to="/agents" className={navLinkClass}>
            ...
            <span className="group-hover:translate-x-1 transition-transform duration-200">Agent / Client</span>
          </Link>
    ...
    if (role === 'authorizer') {
      return (
        <>
          <Link to="/authorizer" className={navLinkClass}>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            <span className="group-hover:translate-x-1 transition-transform duration-200">Authorization</span>
          </Link>
          <Link to="/settings" className={navLinkClass}>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
    ...
    if (role === 'finance_admin') {
      return (
        <>
          <Link to="/finance" className={navLinkClass}>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link to="/finance-ar" className={navLinkClass}>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
            <span className="group-hover:translate-x-1 transition-transform duration-200">AR / AP</span>
          </Link>
          <Link to="/bookings" className={navLinkClass}>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
    ...
    return (
      <>
        <Link to="/create-booking" className={navLinkClass}>
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link to="/voucher-management" className={navLinkClass}>
    ...
    <div className={`min-h-screen flex ${darkMode ? 'dark' : ''}`}>
      ...
      <div className={`bg-gray-900 dark:bg-gray-800 text-white w-64 flex flex-col fixed h-screen ${
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          {/* Home Link — hidden for finance_admin (Finance Dashboard is their home) */}
